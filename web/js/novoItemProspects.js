function addRow(tableID) {
    ...
    element4.type = "text";
    element4.name = "nomecontatoitem" + rowCount;
    element4.id = "nomecontatoitem" + rowCount;
    element4.placeholder = "Nome Contato";
    ...
    element5.type = "text";
    element5.name = "briefing" + rowCount;
    element5.id = "briefing" + rowCount;
    element5.placeholder = "Comentário";
    element5.required = true;
    element5.setAttribute('maxlength',500);
