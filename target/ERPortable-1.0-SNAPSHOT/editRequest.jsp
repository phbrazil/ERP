...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div align ="center">
            ...
            <form name = "editRequest" id ='editRequest' action="${pageContext.request.contextPath}/approvalRequest" method="POST">
                <div class="row" style="width: 70%;">
                    <div class="col-md-6 mb-3" data-toggle="tooltip" title='Nome do Fornecedor'>
                        ...
                        <div class="input-group">
                            <input readonly value="${pedido.razaosocial}" autocomplete="off" onchange="naBaseFornecedor(this.value)" autofocus name="razaosocial" type="text" class="form-control" id="razaosocial" placeholder=""   maxlength ="60" required>
                    ...
                    <div class="col-md-6 mb-3" data-toggle="tooltip" title='Nome do produto'>
                        ...
                        <div class="input-group">
                            ...
                            <input readonly value="${pedido.nomeprod}" required autocomplete="off" onchange="naBaseProduto(this.value)" data-toggle="tooltip"  class="form-control form-control-dark w-100" id="nomeprod" type="text"  aria-label="Search" name ="nomeprod"/>
                    ...
                    <div class="col-md-3 mb-3" data-toggle="tooltip" title='Quantidade a ser comprada'>
                        ...
                        <div class="input-group">
                            <input readonly value="${pedido.qtd}" autocomplete="off" name="qtd" type="number" class="form-control" id="qtd" placeholder="" value ='1' min='1' required>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Parcelamento</label>
                        <div class="input-group">
                            <input type="text" value = "${pedido.parcelamento}" readonly name = "parcelamento" data-toggle="tooltip" title="Parcelamento da compra" data-placement="bottom" class="form-control" id="parcelamento"  required>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Entrega</label>
                        <div class="input-group">
                            <input type="text" value ="${pedido.entrega}" readonly name = "entrega" data-toggle="tooltip" title="Entrega da compra" data-placement="bottom" class="form-control" id="entrega"  required>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label>Prioridade</label>
                        <div class="input-group">
                            <input type="text" value = "${pedido.prioridade}" readonly name = "prioridade" data-toggle="tooltip" title="Prioridade da compra" data-placement="bottom" class="form-control" id="prioridade"  required>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label>Observações</label>
                        <div align ="center">
                            <textarea readonly onkeydown="charactersCount('obsCount', this.value)" maxlength="200" id='obs' name ='obs' class="col-md-5 mb-3">${pedido.obs}</textarea>     
                        </div>
